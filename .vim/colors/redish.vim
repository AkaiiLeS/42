...
let s:stand_out1          = [ '#F3F6F4', 255 ]
let s:stand_out2          = [ '#F3F6F4', 255 ]
...
call s:SetHl('SpecialKey', s:red, s:normal_bg)
...
" MISC "
call s:SetHl('Underlined', s:red, s:normal_bg)
...
call s:SetHl('SpellLocal', s:red, s:normal_bg)
